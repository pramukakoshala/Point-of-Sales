...
if (isset($_SESSION["type"]) && isset($_SESSION["id"])) {
    ...
    $dep_id = validNumber(decrydata($_GET["d"]), "../");
    $dep_det = mysqli_fetch_assoc(mysqli_query($con, "SELECT * FROM department WHERE dep_id=$dep_id"));
    if ($dep_det != null) {
        ?>
        <!DOCTYPE html>
        <html lang="en">
            ...
            <body>
                ...
                <div id="content">
                    <div id="content-header">
                        <div id="breadcrumb"> <a href="../Dashboard.php" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a> <a href="#" class="tip-bottom"><i class="icon-user"></i> Edit Department</a></div>
                    </div>
                                    ...
                                    <div class="widget-box">
                                        ...
                                        <div class="widget-content nopadding">
                                            ...
                                            <div class="control-group">
                                                ...
                                                <div class="controls">
                                                    <input type="text" class="span11" name="vendor_name" value="<?= $dep_det['name'] ?>" placeholder="Department name" required/>
                                                </div>
                                            </div>
                                            <div class="control-group">
                                                <label class="control-label">Department Address</label>
                                                <div class="controls">
                                                    <textarea class="span11" name="vendor_address"><?= $dep_det['address'] ?></textarea>
                                                </div>
                                            </div>
                                            <div class="control-group">
                                                <label class="control-label">Department Contact :</label>
                                                <div class="controls">
                                                    <input type="number" name="company_phone" class="span11" value="<?= $dep_det['phone'] ?>" placeholder="(081) XXX XXXX" />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="widget-box">
                                        ...
                                        <div class="widget-content nopadding">
                                            <div class="control-group">
                                                ...
                                                <div class="controls">
                                                    <input type="email" name="company_email"value="<?= $dep_det['email'] ?>" class="span11" placeholder="Department Email" />
                                                </div>
                                            </div>
                                            <div class="control-group">
                                                ...
                                                <div class="controls">
                                                    <select name="vendor_status">
                                                        <option value="1" <?= ($dep_det['status'] == 1) ? 'selected' : null ?>>Active</option>
                                                        <option value="2" <?= ($dep_det['status'] == 0) ? 'selected' : null ?>>Inactive</option>
                                                    </select>
                                                </div>
                                            </div>
                                            <div class="control-group">
                                            ...
                                            <div class="form-actions">
                                                <button type="submit" name='submit' class="btn btn-success" style="width: 40%">Update Department</button>
        ...
        if (isset($_POST['submit'])) {
            ...
            $sql = "UPDATE `department` SET `name`=\"$name\",`address`= \"$address\", `phone`=\"$phone\", `email`=\"$email\", `logo`=\"$image\", `status`=\"$status\" WHERE `dep_id`=\"$dep_id\"";
